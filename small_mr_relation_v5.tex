...
%% correct number of &s.
\tablehead{\colhead{Name} & \colhead{Per} & \colhead{Mass$^a$} & \colhead{Radius} & \colhead{Flux} & \colhead{First Ref.} & \colhead{Mass, Radius Ref.} \\ 
